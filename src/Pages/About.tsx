...
function About() {
  ...
  return (
    <div className={`h-full w-full  ${darkMode === true ? 'bg-gray-800 text-gray-300' : 'bg-gray-100 text-gray-700'}`}>
      <div className={`h-96 w-full flex flex-col lg:flex-row ${darkMode === true ? ' bg-gradient-to-b from-gray-700 to-gray-800' : 'bg-gradient-to-b from-gray-100 to-gray-200'} `}>
      ...
      <div className={`flex flex-col py-24 h-full items-center ${darkMode === true ? 'bg-gradient-to-b from-gray-800 to-gray-900' : 'bg-gradient-to-b from-gray-200 to-gray-300'} `}>
        <div className='grid place-items-center h-full'>
          <p className={`text-base leading-6 px-6 lg:px-72 text-left ${darkMode === true ? 'text-white ' : ' text-black'} `}>
