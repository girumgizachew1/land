...
function ContactForm() {
  ...
  return (
    <div className={`fontmono ${darkMode === true ? 'bg-gray-800 text-gray-200 shadow-lg shadow-zinc-900/50 ' : 'bg-gray-200 text-gray-800 shadow-lg shadow-white/50'}`}>
