...
function Agency() {
    ...
    return (
        <div className={`flex flex-col justify-center first-letter py-20  ${darkMode === true ? 'bg-gray-900 text-gray-100 shadow-lg shadow-zinc-900/50 ' : 'bg-gray-100 text-gray-900 shadow-lg shadow-white/50'}`}>
            ...
            <div className="flex flex-col md:flex-row gap-4 mx-auto justify-center px-4 py-10 ">
                <div className={` hover:text-cyan-500 border flex flex-col items-center justify-center w-96 h-72  text-center text-4xl rounded-xl  ${darkMode === true ? 'bg-cyan-900  shadow-xl border-zinc-900 text-zinc-100  shadow-black/20' : 'bg-cyan-100 border-cyan-50 text-gray-900 shadow-lg shadow-white/50'}`}>
                ...
                <div className={`hover:text-cyan-500 flex flex-col items-center justify-center border w-96 h-72  text-center text-4xl rounded-xl  ${darkMode === true ? 'bg-cyan-900 shadow-xl border-zinc-900 text-zinc-100 shadow-black/20' : 'bg-cyan-100 border-cyan-50 text-gray-900 shadow-lg shadow-white/50'}`}>
