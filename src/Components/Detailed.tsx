...
function Detailed() {
    ...
    return (
        <div className={`flex flex-col justify-center py-4 space-y-10 items-center first-letter ${darkMode === true ? 'bg-gray-800 text-gray-300 shadow-lg shadow-zinc-900/50 ' : 'bg-gray-100 text-gray-700 shadow-lg shadow-white/50'}`}>
            <div className='h-full w-full flex flex-col lg:flex-row space-x-14 justify-center items-center px-4 md:px-40' >
                <div className='basis-1/2' >
                    <img src='./service.webp' className={`h-96 w-full object-cover filter brightness-85 opacity-75 rounded-2xl `} ></img>
                </div>
            ...
            <div className='h-full w-full flex flex-col-reverse lg:flex-row space-x-14 justify-center items-center px-4 md:px-40 ' >
                <div className='basis-1/2 space-y-6 ' >
                ...
                <div className='basis-1/2' >
                    <img src='./service2.png' className={`h-96 w-full object-cover filter brightness-85 opacity-75 rounded-2xl `} ></img>
                </div>
            </div>
        </div>
    )
